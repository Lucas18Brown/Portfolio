...
function Project1() {
  return (
    <div className="project1">
      ...
      <Carousel>
        <CarouselItem><img src={Landing} alt='landing page' className='pxlsounds-img'></img></CarouselItem>
        <CarouselItem><img src={Home} alt='home page' className='pxlsounds-img'></img></CarouselItem>
        <CarouselItem><img src={New} alt='new page' className='pxlsounds-img'></img></CarouselItem>
        <CarouselItem><img src={Edit} alt='edit page' className='pxlsounds-img'></img></CarouselItem>
      </Carousel>
    </div>
  )
}
